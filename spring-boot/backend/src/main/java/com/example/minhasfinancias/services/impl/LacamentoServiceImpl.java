...
@Service
public class LacamentoServiceImpl implements LancamentoService {
    
    private LancamentoRepository repository ;
    
    public LacamentoServiceImpl(LancamentoRepository repository) {
    ...
    public BigDecimal obterSaldoPorUsuario(
            Long id) {
